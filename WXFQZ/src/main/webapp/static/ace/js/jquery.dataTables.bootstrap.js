...
if ( $.fn.dataTable.Api ) {
	...
	$.fn.dataTable.ext.renderer.pageButton.bootstrap = function ( settings, host, idx, buttons, page, pages ) {
		...
		var disabled = "";
		if(settings.oFeatures.bMaxDataNumber/10>pages){
			disabled=" disabled removeDisabled";
		}else{
			disabled=" disabled"
		}
		if(settings.oFeatures.bMaxDataNumber/10>pages){
			var tempA = buttons[1][buttons[1].length-1];
			buttons[1].push("ellipsis");
		}
