...
<div class="header smaller lighter blue">
	<h1>中国企业发票流向图</h1>
	<a href="${ctxPath}/v1/html/modelReport/microcosmic/list.do"class="detailGoBack">返回</a>
</div>
</div>
	<div class="col-xs-12" id=container style="height: 500px;margin-bottom:20px;"></div>
	<div class="col-xs-4">
		<div class="table-header">北京发票流向图</div>
		<table
		...
		<div class="col-xs-4">
		<div class="table-header">上海发票流向图</div>
		<table
			class="resultTable table table-info table-striped table-bordered table-hover">
			<thead>
				<tr>
		...
		<div class="col-xs-4">
		<div class="table-header">广州发票流向图</div>
...
<script src="${ctxPath}/static/source/js/echarts.js"></script>
       <script type="text/javascript" src="http://echarts.baidu.com/gallery/vendors/echarts/extension/dataTool.min.js"></script>
        <script type="text/javascript" src="${ctxPath}/static/source/js/echart/china.js"></script>
