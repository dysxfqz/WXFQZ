...
<body>
	...
	<div class="header smaller lighter blue">
		...
		<a href="${ctxPath}/v1/html/data/dataCollect/peopleImport/add.do" class=" btn btn-app btn-success newTaxBtn" style="margin-bottom:10px;">新建</a>
			...
			<tbody>
				<c:forEach items="${xlsjyList}" var="bean" varStatus='status'>
					<tr>
						...
						<td align="center">
						<c:if test="${bean.zt == 2}"><a href="${ctxPath}/v1/html/data/sampleData/peopleImport/detail.do?sjyId=${bean.id}" title="详情">详情</a></c:if>
							<c:if test="${bean.zt == 2}"><a href="${ctxPath}/v1/html/data/sampleData/peopleImport/overview.do?sjyId=${bean.id}" title="概览">概览</a></c:if>
