...
<body>
	<div class="col-xs-12">
		<div class="header smaller lighter blue">
			<h1>数据源详情</h1>
			<a href="${ctxPath}/v1/html/data/sampleData/list.do" class="detailGoBack">返回</a>
		</div>
		...
		$("#economicsDiv table th").mouseenter(function(e){
			if(mouseEnterLock){
				...
				mouseEnterLock = false;
 				$.ajax({
					url:"${ctxPath}/v1/html/data/sampleData/getData.do",
 					type:"post",
 					dataType:"json",
 					data:{
 						field:enName,
	...
	function loadNewData(el){
		...
		if($(el).attr("class").indexOf("removeDisabled")>=0){
			...
			var  activePage = $("#economicsDiv .paginate_button.active a").html();
			 $.ajax({
				url:"${ctxPath}/v1/html/data/sampleData/getBatchData.do",
				type:"post",
				data:{
					batch:batch,
					pageSize:pageSize,
